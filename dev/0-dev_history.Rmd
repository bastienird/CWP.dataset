...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Package to analyse and tidy fisheries dataset on CWP standards",
    Description = "This package is to easily analyse standardized CWP data and to compare different datasets.",
    `Authors@R` = c(
      person("Bastien", "Grasset", email = "bastien.grasset@ird.fr", role = c("aut", "cre"), comment = c(ORCID = "0000-0002-9946-1338"))
    )
  )
)
# Define License with use_*_license()
usethis::use_mit_license("Bastien Grasset")
```
