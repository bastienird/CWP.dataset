...
```{r spatialcoverage, eval=(exists("spatial_coverage_analysis_list", envir =environment()) && !is.null(spatial_coverage_analysis_list)), echo=FALSE, message=FALSE, (exists("spatial_coverage_analysis_list", envir=environment()) && !is.null(spatial_coverage_analysis_list)), results='asis'}
...
```{r otherdimensionanalysis, eval=(exists("other_dimension_analysis_list", envir =environment()) && !is.null(other_dimension_analysis_list)) && !unique_analyse, echo=FALSE, message=FALSE, warning=FALSE, (exists("other_dimension_analysis_list", envir=environment()) && !is.null(other_dimension_analysis_list)) && !unique_analyse, results='asis'}
