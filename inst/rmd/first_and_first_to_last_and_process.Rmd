...
res_last <- knitr::knit_child(system.file("rmd/comparison.Rmd", package = "CWP.dataset"), quiet = TRUE, envir = environment())
...
res_comparison_first_to_last <- knitr::knit_child(system.file("rmd/comparison.Rmd", package = "CWP.dataset"), quiet = TRUE, envir = environment())
