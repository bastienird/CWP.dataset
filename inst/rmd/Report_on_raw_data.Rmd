...
```{r statsirregularareasflextable,echo=FALSE, results = 'asis', eval=file.exists(file.path(entity_dir, "/data/stats_irregular_areas.csv"))}
...
```{r summaryofthenotmappedfactors,echo=FALSE, results = 'asis', eval=file.exists(file.path(entity_dir, "/data/not_mapped_total.csv"))}
